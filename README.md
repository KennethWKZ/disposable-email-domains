...
> **Last Updated**: September 6, 2026 at 08:20 PM UTC | **Next Sync**: Automated twice daily (6 AM & 6 PM UTC)
...
|:---:|:---:|:---:|:---:|
| **0.70s** | **100.0%** | **2.0 MB** | **198,175 removed** |
...
|------------|---------|---------|-------------|
| [kslr/disposable-email-domains](https://github.com/kslr/disposable-email-domains) | 125,201 | ✅ | 0.34s (1.9 MB) |
| [disposable/disposable-email-domains](https://github.com/disposable/disposable-email-domains) | 75,287 | ✅ | 0.29s (1.1 MB) |
...
| [7c/fakefilter](https://github.com/7c/fakefilter) | 10,389 | ✅ | 0.03s (143.0 KB) |
| [disposable-email-domains/disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) | 8,737 | ✅ | 0.04s (121.4 KB) |
...
- **Processing Efficiency**: 191475 domains/second
