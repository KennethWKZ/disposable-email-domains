...
> **Last Updated**: May 30, 2026 at 08:38 AM UTC | **Next Sync**: Automated twice daily (6 AM & 6 PM UTC)
...
|:---:|:---:|:---:|:---:|
| **0.96s** | **100.0%** | **1.9 MB** | **206,563 removed** |
...
|------------|---------|---------|-------------|
| [kslr/disposable-email-domains](https://github.com/kslr/disposable-email-domains) | 119,938 | ✅ | 0.46s (1.8 MB) |
| [disposable/disposable-email-domains](https://github.com/disposable/disposable-email-domains) | 72,296 | ✅ | 0.47s (1.1 MB) |
| [FGRibreau/mailchecker](https://github.com/FGRibreau/mailchecker) | 56,048 | ✅ | 0.22s (840.7 KB) |
| [wesbos/burner-email-providers](https://github.com/wesbos/burner-email-providers) | 27,283 | ✅ | 0.34s (388.1 KB) |
| [groundcat/disposable-email-domain-list](https://github.com/groundcat/disposable-email-domain-list) | 23,995 | ✅ | 0.30s (336.1 KB) |
| [sublime-security/static-files](https://github.com/sublime-security/static-files) | 10,523 | ✅ | 0.17s (144.0 KB) |
| [7c/fakefilter](https://github.com/7c/fakefilter) | 9,664 | ✅ | 0.28s (134.5 KB) |
| [disposable-email-domains/disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) | 5,488 | ✅ | 0.10s (69.6 KB) |
...
- **Processing Efficiency**: 134910 domains/second
