...
> **Last Updated**: April 24, 2026 at 07:07 PM UTC | **Next Sync**: Automated twice daily (6 AM & 6 PM UTC)
...
|:---:|:---:|:---:|:---:|
| **0.63s** | **100.0%** | **1.9 MB** | **210,298 removed** |
...
|------------|---------|---------|-------------|
| [kslr/disposable-email-domains](https://github.com/kslr/disposable-email-domains) | 118,921 | ✅ | 0.30s (1.8 MB) |
| [disposable/disposable-email-domains](https://github.com/disposable/disposable-email-domains) | 72,180 | ✅ | 0.29s (1.0 MB) |
| [FGRibreau/mailchecker](https://github.com/FGRibreau/mailchecker) | 56,047 | ✅ | 0.17s (840.8 KB) |
...
| [7c/fakefilter](https://github.com/7c/fakefilter) | 9,466 | ✅ | 0.05s (132.2 KB) |
...
- **Processing Efficiency**: 205080 domains/second
