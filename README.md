...
> **Last Updated**: May 2, 2026 at 07:14 PM UTC | **Next Sync**: Automated twice daily (6 AM & 6 PM UTC)
...
|:---:|:---:|:---:|:---:|
| **0.69s** | **100.0%** | **1.9 MB** | **210,418 removed** |
...
|------------|---------|---------|-------------|
| [kslr/disposable-email-domains](https://github.com/kslr/disposable-email-domains) | 119,285 | ✅ | 0.33s (1.8 MB) |
| [disposable/disposable-email-domains](https://github.com/disposable/disposable-email-domains) | 72,276 | ✅ | 0.33s (1.1 MB) |
...
| [7c/fakefilter](https://github.com/7c/fakefilter) | 9,501 | ✅ | 0.10s (132.7 KB) |
| [disposable-email-domains/disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) | 5,414 | ✅ | 0.05s (68.7 KB) |
...
- **Processing Efficiency**: 186286 domains/second
