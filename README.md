...
> **Last Updated**: July 24, 2026 at 08:38 AM UTC | **Next Sync**: Automated twice daily (6 AM & 6 PM UTC)
...
| [disposable/disposable-email-domains](https://github.com/disposable/disposable-email-domains) | 74,646 | ✅ | 0.36s (1.1 MB) |
...
| [groundcat/disposable-email-domain-list](https://github.com/groundcat/disposable-email-domain-list) | 10,863 | ✅ | 0.23s (154.2 KB) |
| [sublime-security/static-files](https://github.com/sublime-security/static-files) | 10,522 | ✅ | 0.22s (144.0 KB) |
| [7c/fakefilter](https://github.com/7c/fakefilter) | 10,244 | ✅ | 0.18s (141.7 KB) |
| [disposable-email-domains/disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) | 8,143 | ✅ | 0.16s (113.1 KB) |
...
- **Processing Efficiency**: 158640 domains/second
