...
> **Last Updated**: May 19, 2026 at 10:01 AM UTC | **Next Sync**: Automated twice daily (6 AM & 6 PM UTC)
...
|:---:|:---:|:---:|:---:|
| **0.62s** | **100.0%** | **1.9 MB** | **210,470 removed** |
...
|------------|---------|---------|-------------|
| [kslr/disposable-email-domains](https://github.com/kslr/disposable-email-domains) | 119,692 | ✅ | 0.27s (1.8 MB) |
| [disposable/disposable-email-domains](https://github.com/disposable/disposable-email-domains) | 72,255 | ✅ | 0.27s (1.0 MB) |
...
| [7c/fakefilter](https://github.com/7c/fakefilter) | 9,562 | ✅ | 0.09s (133.3 KB) |
| [disposable-email-domains/disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) | 5,467 | ✅ | 0.02s (69.3 KB) |
...
- **Processing Efficiency**: 208985 domains/second
